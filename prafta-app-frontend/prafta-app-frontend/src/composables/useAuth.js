// src/composables/useAuth.js (APP)
// 세션·토큰 관련 단일 진입점. web 프론트(@/composables/useAuth)와 동일한 구조.
 ...
 * - APP은 X-Client-Type 헤더를 항상 APP으로 보낸다.
 */
