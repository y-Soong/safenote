<template>
  <div class="viewComm">
    ...
    <div class="viewBody leave-dashboard">
      ...
      <div class="ld-bulk-bar" :class="{ 'is-empty': selectedUserCds.length === 0 }">
        ...
        <table class="ld-table">
          ...
          <thead>
            <tr>
              ...
              <th colspan="4" class="ld-parent-header ld-grp-legal">법정 휴가</th>
          ...
          <tbody>
            ...
            >
              ...
              <td class="is-right ld-grp-nonlegal">{{ row.nonLegal.used }}일</td>
