...
const props = defineProps({ linkId: [Number, String], onSaved: Function });
...
// 거부 — POST /webApi/subcon02/site-link-reject { linkId, comment }.
...
const fnReject = async () => {
  ...
  try {
    const response = await axios.post("/webApi/subcon02/site-link-reject", {
      linkId: props.linkId,
