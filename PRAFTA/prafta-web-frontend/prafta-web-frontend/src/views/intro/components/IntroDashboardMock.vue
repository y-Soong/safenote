    ...
    <aside class="dash__lnb">
      ...
      <nav class="dash__nav">
        <span class="dash__nav-item is-active"
          ><i class="ico ico--grid"></i>대시보드</span
        >
        <span class="dash__nav-item"
          ><i class="ico ico--clock"></i>근태·인사</span
        >
        <span class="dash__nav-item"
          ><i class="ico ico--shield"></i>산업안전</span
        >
        <span class="dash__nav-item"
          ><i class="ico ico--check"></i>안전점검</span
        >
        <span class="dash__nav-item"><i class="ico ico--doc"></i>리포트</span>
      </nav>
      <span class="dash__nav-item dash__nav-item--bottom"
        ><i class="ico ico--cog"></i>설정</span
      >
    </aside>
      ...
      <div class="dash__body">
        ...
        <div class="panels">
            ...
            <div class="bars">
              <div v-for="d in week" :key="d.day" class="bars__col">
                <div class="bars__stack">
                  <span
                    class="bars__seg seg--leave"
                    :style="{ height: d.leave + 'px' }"
                  ></span>
                  <span
                    class="bars__seg seg--late"
                    :style="{ height: d.late + 'px' }"
                  ></span>
                  <span
                    class="bars__seg seg--work"
                    :style="{ height: d.work + 'px' }"
                  ></span>
                </div>
          ...
          <section class="panel">
            ...
            <ul class="safe">
              <li>
                <span class="safe__ic">🦺</span
                ><span class="safe__nm">TBM 완료</span><b>18/20</b>
              </li>
              <li>
                <span class="safe__ic">📋</span
                ><span class="safe__nm">안전점검</span><b>24건</b>
              </li>
              <li>
                <span class="safe__ic">⚠️</span
                ><span class="safe__nm">아차사고 신고</span><b>3건</b>
              </li>
            </ul>
            <div class="gauge">
          ...
          <table class="rtable">
            ...
            <tbody>
              <tr v-for="r in reports" :key="r.id">
                ...
                <td>
                  <span class="grade" :class="'grade--' + r.level">{{
                    r.grade
                  }}</span>
                </td>
                <td>
                  <span class="stat" :class="'stat--' + r.s">{{
                    r.status
                  }}</span>
                </td>
              </tr>
...
const reports = [
  {
    id: 1,
    name: "김현수",
    desc: "2공정 컨베이어 비상정지 스위치 식별 표시 마모",
    grade: "높음",
    level: "high",
    status: "조치중",
    s: "doing",
