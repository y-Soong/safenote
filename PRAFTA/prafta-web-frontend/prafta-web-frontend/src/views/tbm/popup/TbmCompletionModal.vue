        ...
        <div class="comp-body">
          ...
          <div class="comp-radio-group">
            <label class="comp-radio">
              <input type="radio" value="COMPLETED" v-model="newStatusCd" />
              이수
            </label>
            <label class="comp-radio">
              <input type="radio" value="NOT_COMPLETED" v-model="newStatusCd" />
              미이수
            </label>
          </div>
          ...
          <div class="comp-reason">
            ...
            <div class="comp-reason-meta">
              <span
                v-if="reason.trim().length > 0 && reason.trim().length < 10"
                class="comp-hint"
              >
                10자 이상 입력해 주세요.
              </span>
...
const { startDrag } = useCenteredDraggable(modalRef, {
  horizontalRatio: 2,
  verticalRatio: 3,
});
...
const isValid = computed(
  () => !!newStatusCd.value && reason.value.trim().length >= 10
);
