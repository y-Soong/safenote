    ...
    >
      ...
      <section class="lp-card">
        ...
        <div class="lp-note lp-note--legal">
          ...
          <span>
            ...
            적용 (근로기준법 제60조 제2항).
            <br />
            단, <strong>경력 인정</strong>을 받은 직원은 인정 경력을 더한 산정
            근속이 1년 이상이 되는 시점부터 월차가 발생하지 않습니다(재직자와
            동일 대우 — 사용자 정보의 경력 인정 항목 참조).
          </span>
        </div>
      </section>
      ...
      <section class="lp-card lp-usage">
        ...
        <p class="lp-strong-note">
          ...
          환산해 차감하며, <strong>근무계획이 배정된 날만</strong> 신청할 수
          있습니다. 휴게시간은 자동 제외되어 신청 불가.
        </p>
      </section>

      <!-- ============ 시간차 1일 환산시간 — 당일 배정 스케줄 기준 (E1 당일분모 전환) ============ -->
      <div class="lp-divider">
