    ...
    <div v-show="true" class="modal-overlay prafta-modal-popup">
      <div class="modal-content-narrow">
        ...
        <div class="form-container">
          <p class="chkpt-unlink-warn">
            '{{ props.siteNm }}'의 순회점검 구성 연동을 해제합니다.
          </p>
          <ul class="chkpt-unlink-guide">
            <li>
              연동된 점검대상·문항은 해제 즉시
              <b>수신 회사의 자체 점검 구성</b>으로 전환됩니다(잠금 해제).
            </li>
            <li>
              <b>점검 결과 통합이 중단</b>됩니다. 이후 각 회사의 점검은 자기
              회사에만 기록됩니다.
            </li>
            <li>
              이미 쌓인 점검 실적·불량조치·사진은
              <b>양쪽 모두 그대로 보존</b>됩니다.
            </li>
            <li>
              다시 연동하면 <b>새 점검대상·문항이 생성</b>됩니다(기존 항목에
              다시 붙지 않습니다).
            </li>
            <li>
              사업장 연동은 유지됩니다(사업장 연동까지 끊으려면 '해지'를
              사용하세요).
            </li>
          </ul>
        </div>
