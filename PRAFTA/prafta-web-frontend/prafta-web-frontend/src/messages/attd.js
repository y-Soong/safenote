...
export const ATTD_MESSAGES = {
  ...
  OVERNIGHT_CONFIRM:
    "{section} 종료시간이 시작시간보다 빠릅니다.\n자정을 넘기는 오버나이트(야간) 근무로 처리할까요?",
  LEAVE_SAVE_CONFIRM:
  ...
  // prafta-com-013-05(재작업) 결함④: 교대팀 멤버 제외(탈퇴 마킹) 성공 안내. "삭제/저장"이 아닌 "제외" 의미.
  SHIFT_TEAM_USER_EXCLUDED: "제외되었습니다.",
  // prafta-com-016-D-3: 조원 추가 시 덮어쓰기 범위(합류일 다음날 ~ 교대근무 종료일) 안내 confirm.
  //   실제 기준일은 서버가 산출(클라 today 신뢰 금지) — 본 문구는 안내용.
  SHIFT_USER_ADD_CONFIRM:
    "선택한 사용자를 교대팀에 추가합니다.\n합류일 다음 날부터 교대근무 종료일({endDate})까지\n근무 스케줄이 교대근무 스케줄로 변경됩니다.\n(연차·초과근무가 등록된 날은 변경되지 않습니다.)\n계속하시겠습니까?",
  // prafta-com-016-D-5: 기간 수정 저장 confirm. 연장만 반영·단축 미변경 안내.
  SHIFT_PERIOD_CHANGE_CONFIRM:
    "변경되는 날짜까지 소속된 인원들의 근무 스케줄이 변경됩니다.\n(기간이 기존보다 길어진 경우는 소속된 사용자들의 스케줄에 반영되지만\n짧아진 경우는 스케줄을 변경하지 않습니다.)",
  // prafta-com-016-D-6: 교대근무 팀 삭제 confirm. 교대타입명이 아닌 교대근무 팀명 표시.
  SHIFT_TEAM_DELETE_CONFIRM:
  ...
  // ── 초과근무 (PRAFTA-003) ────────────────────────────────
  OT_SAVE_CONFIRM: "초과근무를 저장하시겠습니까?",
  OT_LIST_EMPTY: "저장할 초과근무 내역이 없습니다.",
  OT_RANGE_INVALID:
    "초과근무 시작/종료 시간이 올바르지 않습니다.\n시작 시간이 종료 시간보다 빨라야 합니다.",
  OT_OUTSIDE_ALLOWED:
    "초과근무 시간이 등록 가능 범위를 벗어났습니다.\n표시된 등록 가능 시간 안에서만 등록할 수 있습니다.",
  OT_OVERLAP:
    "초과근무 구간이 서로 겹칩니다.\n시간이 겹치지 않도록 수정해 주세요.",
  OT_SAVE_ERROR: "초과근무 저장 중 오류가 발생했습니다.",
  // com-013 #6: 등록된 초과근무 삭제
  OT_DELETE_CONFIRM: "등록된 초과근무를 삭제하시겠습니까?",
  OT_DELETE_ERROR: "초과근무 삭제 중 오류가 발생했습니다.",
};
