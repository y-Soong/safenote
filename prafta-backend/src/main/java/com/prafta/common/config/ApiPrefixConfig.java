        ...
        protected void registerHandlerMethod(Object handler, Method method, RequestMappingInfo mapping) {
            ...
            if (prefix != null && mapping != null && mapping.getPatternsCondition() != null) {
                ...
                mapping = RequestMappingInfo
                        ...
                        .consumes(mapping.getConsumesCondition().getConsumableMediaTypes().toArray(new String[0]))
                        .produces(mapping.getProducesCondition().getProducibleMediaTypes().toArray(new String[0]))
