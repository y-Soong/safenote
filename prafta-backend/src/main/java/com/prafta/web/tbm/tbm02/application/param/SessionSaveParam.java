...
public record SessionSaveParam(
	String saveMode				// OPENED / DRAFT
	, String siteCd
	, String title
	, String contentBody
	...
	public static SessionSaveParam from(SessionSaveRequest request, TokenInfo tokenInfo) {
