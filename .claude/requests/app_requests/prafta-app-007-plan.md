...
| **P13** | 1구간 only vs 2구간 분기 | **"구간 추가" 버튼 — 1구간 only 일 때만 노출**. 2구간 도달 시 버튼 숨김/비활성. 시안 §2-3 "3구간 추가 불가" 명시. 2구간 카드의 "삭제" 버튼으로 다시 1구간으로 축소 가능. | 시안 §1-1/§2-1/§3-1 (1구간) → "구간 추가" 노출. §1-2/§2-2/§3-2 (2구간) → 삭제 버튼 노출. |
